...
import org.apache.commons.collections15.map.AbstractTestMultiMap;
 ...
 */
public class TestMultiHashMap extends AbstractTestMultiMap {
    ...
    static private MapPair[][] sMapPairs = {{new MapPair(0, "zero")}, {new MapPair(1, "one"), new MapPair(1, "ONE"), new MapPair(1, "uno")}, {new MapPair(2, "two"), new MapPair(2, "two")}, {new MapPair(3, "three"), new MapPair(3, "THREE"), new MapPair(3, "tres")}, {new MapPair(4, "four"), new MapPair(4, "quatro")}};
    ...
    // confirmed map (they're going to be collections15 of values instead).
    public void verifyMap() {
        // TODO: implement test to ensure that map is the same as confirmed if
        // its values were converted into collections15.
    }
