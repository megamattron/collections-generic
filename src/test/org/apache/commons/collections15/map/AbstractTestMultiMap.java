...
import org.apache.commons.collections15.AbstractTestObject;
...
import org.apache.commons.collections15.set.AbstractTestSet;
 ...
 * <p/>
 * The forces at work here are similar to those in {@link org.apache.commons.collections15.collection.AbstractTestCollection}.
 ...
 */
public abstract class AbstractTestMultiMap extends AbstractTestObject {
     ...
     */
    public AbstractTestMultiMap(String testName) {
        super(testName);
    }
    ...
    public Object[] getSampleKeys() {
        Object[] result = new Object[]{"blah", "foo", "bar", "baz", "tmp", "gosh", "golly", "gee", "hello", "goodbye", "we'll", "see", "you", "all", "again", "key", "key2", (isAllowNullKey() && !JDK12) ? null : "nonnullkey"};
        return result;
    }
    ...
    public class TestMapEntrySet extends AbstractTestSet {
        ...
        public boolean isRemoveSupported() {
            ...
            return AbstractTestMultiMap.this.isRemoveSupported();
        }

        public boolean isGetStructuralModify() {
            return AbstractTestMultiMap.this.isGetStructuralModify();
        }
        ...
        public void resetFull() {
            AbstractTestMultiMap.this.resetFull();
            collection = map.entrySet();
            TestMapEntrySet.this.confirmed = AbstractTestMultiMap.this.confirmed.entrySet();
        }

        public void resetEmpty() {
            AbstractTestMultiMap.this.resetEmpty();
            collection = map.entrySet();
            TestMapEntrySet.this.confirmed = AbstractTestMultiMap.this.confirmed.entrySet();
        }
        ...
        public void testMapEntrySetIteratorEntry() {
            ...
            while (it.hasNext()) {
                ...
                assertEquals(true, AbstractTestMultiMap.this.map.containsKey(entry.getKey()));
                assertEquals(true, AbstractTestMultiMap.this.map.containsValue(entry.getValue()));
                if (isGetStructuralModify() == false) {
                    assertEquals(AbstractTestMultiMap.this.map.get(entry.getKey()), entry.getValue());
                }
                count++;
            }
        ...
        public void testMapEntrySetIteratorEntrySetValue() {
            ...
            assertEquals(true, AbstractTestMultiMap.this.map.containsKey(entry1.getKey()));
            assertEquals(true, AbstractTestMultiMap.this.map.containsValue(newValue1));
            assertEquals(newValue1, AbstractTestMultiMap.this.map.get(entry1.getKey()));
            verify();
            ...
            assertEquals(true, AbstractTestMultiMap.this.map.containsKey(entry2.getKey()));
            assertEquals(true, AbstractTestMultiMap.this.map.containsValue(newValue2));
            assertEquals(newValue2, AbstractTestMultiMap.this.map.get(entry2.getKey()));
            verify();
        }
        ...
        public void verify() {
            super.verify();
            AbstractTestMultiMap.this.verify();
        }
    }
    ...
    public class TestMapKeySet extends AbstractTestSet {
        ...
        public boolean isNullSupported() {
            return AbstractTestMultiMap.this.isAllowNullKey();
        }
        ...
        public void resetEmpty() {
            ...
            TestMapKeySet.this.confirmed = AbstractTestMultiMap.this.confirmed.keySet();
        }
    ...
    public class TestMapValues extends AbstractTestCollection {
        ...
        public void resetFull() {
            ...
            TestMapValues.this.confirmed = AbstractTestMultiMap.this.confirmed.values();
        }
