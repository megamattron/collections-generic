...
public class TestPredicatedSortedMap extends AbstractTestSortedMap {
    ...
    //-----------------------------------------------------------------------
    protected SortedMap decorateMap(SortedMap map, Predicate keyPredicate, Predicate valuePredicate) {
    ...
    //            "D:/dev/collections15/data/test/PredicatedSortedMap.emptyCollection.version3.1.obj");
    //        resetFull();
    //        writeExternalFormToDisk(
    //            (java.io.Serializable) map,
    //            "D:/dev/collections15/data/test/PredicatedSortedMap.fullCollection.version3.1.obj");
    //    }
}