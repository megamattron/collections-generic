...
public abstract class AbstractTestIterableMap extends AbstractTestMap {
    ...
    //      resetEmpty();
    //      writeExternalFormToDisk((Serializable) map, "D:/dev/collections15/data/test/HashedMap.emptyCollection.version3.obj");
    //      resetFull();
    //      writeExternalFormToDisk((Serializable) map, "D:/dev/collections15/data/test/HashedMap.fullCollection.version3.obj");
    //  }
}
