...
public class TestPredicatedMap extends AbstractTestMap {
    ...
    //-----------------------------------------------------------------------
    protected Map decorateMap(Map map, Predicate keyPredicate, Predicate valuePredicate) {
    ...
    //            "D:/dev/collections15/data/test/PredicatedMap.emptyCollection.version3.1.obj");
    //        resetFull();
    //        writeExternalFormToDisk(
    //            (java.io.Serializable) map,
    //            "D:/dev/collections15/data/test/PredicatedMap.fullCollection.version3.1.obj");
    //    }
}