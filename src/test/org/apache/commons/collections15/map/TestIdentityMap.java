...
public class TestIdentityMap extends AbstractTestObject {
    ...
    public void testEmptyMapCompatibility() throws IOException, ClassNotFoundException {
        ...
        // Disabled as binary compatibility with 3.0 is not supported.
...
//        }
    ...
    //        writeExternalFormToDisk((java.io.Serializable) map, "D:/dev/collections15/data/test/IdentityMap.emptyCollection.version3.obj");
    //        map = new IdentityMap();
    //        map.put(I1A, I2A);
    //        map.put(I1B, I2A);
    //        map.put(I2A, I2B);
    //        writeExternalFormToDisk((java.io.Serializable) map, "D:/dev/collections15/data/test/IdentityMap.fullCollection.version3.obj");
    //    }
}
