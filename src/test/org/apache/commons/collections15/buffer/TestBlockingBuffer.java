...
public class TestBlockingBuffer extends AbstractTestObject {
    ...
    //        writeExternalFormToDisk((java.io.Serializable) buffer, "D:/dev/collections15/data/test/BlockingBuffer.emptyCollection.version3.1.obj");
    //        buffer = BlockingBuffer.decorate(new UnboundedFifoBuffer());
    //        buffer.add("A");
    //        buffer.add("B");
    //        buffer.add("C");
    //        writeExternalFormToDisk((java.io.Serializable) buffer, "D:/dev/collections15/data/test/BlockingBuffer.fullCollection.version3.1.obj");
    //    }
