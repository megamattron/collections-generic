...
public class TestSetUniqueList extends AbstractTestList {
    ...
    public Object[] getFullNonNullElements() {
        ...
        return new Object[]{new String(""), new String("One"), new Integer(2), "Three", new Integer(4), new Double(5), new Float(6), "Seven", "Eight", new String("Nine"), new Integer(10), new Short((short) 11), new Long(12), "Thirteen", "14", "15", new Byte((byte) 16)};
    }
    ...
    public void testCollectionAddAll() {
        ...
        for (int i = 0; i < elements.length; i++) {
            assertTrue("Full collection should contain added element " + i, collection.contains(elements[i]));
        }
    ...
    public void testAddAll() {
        ...
        lset.addAll(Arrays.asList(new Integer[]{new Integer(1), new Integer(1)}));
    ...
    //        resetEmpty();
    //        writeExternalFormToDisk((java.io.Serializable) collection, "D:/dev/collections15/data/test/SetUniqueList.emptyCollection.version3.1.obj");
    //        resetFull();
    //        writeExternalFormToDisk((java.io.Serializable) collection, "D:/dev/collections15/data/test/SetUniqueList.fullCollection.version3.1.obj");
    //    }
