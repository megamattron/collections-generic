...
import org.apache.commons.collections15.iterators.AbstractTestMapIterator;
...
public abstract class AbstractTestBidiMap extends AbstractTestMap {
    ...
    // Test data.
    private static final Object[][] entriesKV = new Object[][]{new Object[]{"key1", "value1"}, new Object[]{"key2", "value2"}, new Object[]{"key3", "value3"}};
    private static final Object[][] entriesVK = new Object[][]{new Object[]{"value1", "key1"}, new Object[]{"value2", "key2"}, new Object[]{"value3", "key3"}};
    ...
    public void testBidiGetKeyInverse() {
        doTestGetKey(makeFullBidiMap().inverseBidiMap(), entries[0][1], entries[0][0]);
    }
