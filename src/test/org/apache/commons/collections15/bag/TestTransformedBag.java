...
public class TestTransformedBag extends AbstractTestBag {
    ...
    //        Bag bag = makeBag();
    //        writeExternalFormToDisk((java.io.Serializable) bag, "D:/dev/collections15/data/test/TransformedBag.emptyCollection.version3.1.obj");
    //        bag = makeBag();
    //        bag.add("A");
    //        bag.add("A");
    //        bag.add("B");
    //        bag.add("B");
    //        bag.add("C");
    //        writeExternalFormToDisk((java.io.Serializable) bag, "D:/dev/collections15/data/test/TransformedBag.fullCollection.version3.1.obj");
    //    }
