...
public class TestHashBag extends AbstractTestBag {
    ...
    //        Bag bag = makeBag();
    //        writeExternalFormToDisk((Serializable) bag, "D:/dev/collections15/data/test/HashBag.emptyCollection.version3.obj");
    //        bag = makeBag();
    //        bag.add("A");
    //        bag.add("A");
    //        bag.add("B");
    //        bag.add("B");
    //        bag.add("C");
    //        writeExternalFormToDisk((Serializable) bag, "D:/dev/collections15/data/test/HashBag.fullCollection.version3.obj");
    //    }
}
