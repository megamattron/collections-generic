 ...
 * @author Phil Steitz
 * @author Matt Hall, John Watkinson, Steven Melzer
...
public class TestCollectionUtils extends TestCase {
    ...
    private Collection<String> collectionA = null;
    private Collection<String> collectionB = null;
    ...
    public void setUp() {
        ...
        collectionA.add("d");
        collectionA.add("d");
        collectionB = new LinkedList<String>();
        collectionB.add("e");
        collectionB.add("d");
        collectionB.add("d");
        collectionB.add("c");
    ...
    public void testIsProperSubCollection() {
        ...
        a.add("1");
        assertTrue(CollectionUtils.isProperSubCollection(b, a));
        assertTrue(CollectionUtils.isProperSubCollection(CollectionUtils.intersection(collectionA, collectionB), collectionA));
    ...
    public void testIndex() {
        ...
        test = CollectionUtils.index(enumeration, 0);
        assertTrue(test.equals("zero"));
        enumeration = vector.elements();
        test = CollectionUtils.index(enumeration, 1);
        assertTrue(test.equals("one"));
    ...
    public void testGet() {
...

        {
            ...
            enumeration = vector.elements();
            assertEquals("one", CollectionUtils.get(enumeration, 1));
        
            // Enumerator, non-existent entry 
            try {
                CollectionUtils.get(enumeration, 3);
                fail("Expecting IndexOutOfBoundsException.");
            } catch (IndexOutOfBoundsException e) {
                // expected
            }
    ...
    //-----------------------------------------------------------------------
    private static Predicate<String> EQUALS_TWO = new Predicate<String>() {
    ...
    public void testCollect() {
        ...
        // null transformer is no longer allowed
...
//        assertTrue(collectionA.size() == size && collectionA.contains("a"));
    ...
    public void testPredicatedCollection() {
        ...
        Collection collection = CollectionUtils.predicatedCollection(new ArrayList(), predicate);
        assertTrue("returned object should be a PredicatedCollection", collection instanceof PredicatedCollection);
        try {
            collection = CollectionUtils.predicatedCollection(new ArrayList(), null);
    ...
    public void testIntersectionUsesMethodEquals() {
        ...
        // Let cola and colb be collections15...
