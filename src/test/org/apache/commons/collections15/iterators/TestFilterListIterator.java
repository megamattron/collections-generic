...
public class TestFilterListIterator extends TestCase {
    ...
    public void testNestedSixes() {
        FilterListIterator filtered = new FilterListIterator(new FilterListIterator(list.listIterator(), threePred), evenPred);
        walkLists(sixes, filtered);
    }

    public void testNestedSixes2() {
        FilterListIterator filtered = new FilterListIterator(new FilterListIterator(list.listIterator(), evenPred), threePred);
        walkLists(sixes, filtered);
    }
