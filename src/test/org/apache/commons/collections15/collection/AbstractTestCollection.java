 ...
 * confirmed collection implementation, the two collections15 are compared to see
 ...
 * {@link #resetFull()} methods set these fields to empty or full collections15,
 ...
 * to provide standard JDK confirmed collections15.<P>
 * <p/>
 * <b>Other notes</b>
 * <p/>
...
public abstract class AbstractTestCollection extends AbstractTestObject {
    ...
    /**
     * Returns true if the collections15 produced by
    ...
    public void verify() {
        ...
        // verify the collections15 are the same by attempting to match each
     ...
     * collections15.  Invoke this method before performing a modification
     * test.
     */
    ...
    /**
     * Makes an object to test add() type functions, override for specific typed collections15 that required
